//! This crate implements the details for the ARM aarch64 ISA. It implements the methods and type
//! parameters for the traits abstracted in [`axcut2backend`]. It is supposed to work on Linux and
//! Apple platforms. For other platforms the calling convention for calls to external functions and
//! for the invocation of the generated assembly routine itself need to be adapted.
//!
//! # Usage
//!
//! Function [`into_routine::into_aarch64_routine`] turns an [`axcut2backend::coder::AssemblyProg`]
