...
impl PDef {
    ...
    pub fn check(mut self, symbol_table: &mut SymbolTable) -> Result<PDef, Error> {
...
impl From<PDef> for Declaration {
    fn from(value: PDef) -> Self {
        Declaration::PDef(value)
    }
}
