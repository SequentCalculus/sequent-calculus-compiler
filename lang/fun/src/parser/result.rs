//! Helper functions and errors for the fun parser
use lalrpop_util::lexer::Token;
use miette::{Diagnostic, SourceOffset, SourceSpan};
use thiserror::Error;

/// Collects a String iterator into a String separated by a given str
fn separated<I: IntoIterator<Item = String>>(s: &str, iter: I) -> String {
    let vec: Vec<_> = iter.into_iter().collect();
    vec.join(s)
}

/// Collects a String iterator into a String separated by `,`
