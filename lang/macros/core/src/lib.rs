...
/// (i.e., a constructor) with given name, arguments and type.
#[proc_macro]
pub fn ctor(input: TokenStream) -> TokenStream {
    unfocused_xtor(input, Chirality::Prd)
}

/// Create a [`core_lang::syntax::terms::xtor::Xtor`] with chirality
/// [`core_lang::syntax::terms::Cns`] (i.e., a destructor) with given name, arguments, and type.
#[proc_macro]
pub fn dtor(input: TokenStream) -> TokenStream {
    unfocused_xtor(input, Chirality::Cns)
}

/// Create a [`core_lang::syntax::terms::xtor::FsXtor`] with chirality [`core_lang::syntax::Prd`],
/// i.e., a focused constructor with given name, arguments, and type.
#[proc_macro]
pub fn fs_ctor(input: TokenStream) -> TokenStream {
    fs_xtor(input, Chirality::Prd)
}

/// Create a [`core_lang::syntax::terms::xtor::FsXtor`] with chirality [`core_lang::syntax::Cns`],
/// i.e., a focussed destructor with given name, arguments, and type.
#[proc_macro]
pub fn fs_dtor(input: TokenStream) -> TokenStream {
    fs_xtor(input, Chirality::Cns)
}

/// Create a [`core_lang::syntax::terms::clause::Clause`] with given chirality, name, arguments,
/// and right-hand side
#[proc_macro]
...
/// Create a [`core_lang::syntax::terms::clause::FsClause`] with given chirality, name, arguments,
/// and right-hand side.
#[proc_macro]
...
/// Create a [`core_lang::syntax::terms::xcase::XCase`] with chirality [`core_lang::syntax::Cns`],
/// i.e., a case expression, withgiven clauses, and continuation type.
/// If the continuation type is not specified, it defaults to
...
/// Create a [`core_lang::syntax::terms::xcase::XCase`] with chirality [`core_lang::syntax::Cns`],
/// i.e., a cocase / new expression with given clauses, and return type.
...
/// Create a [`core_lang::syntax::terms::mu::Mu`] with chirality [`core_lang::syntax::Prd`], i.e.,
/// a mu-binding, with given variable name, bound statement, and type.
...
/// Create a [`core_lang::syntax::terms::mu::Mu`] with chirality [`core_lang::syntax::Cns`], i.e.,
/// a mu-tilde-binding with given variable name, bound statement, and type.
/// If no type is provided, defaults to [`core_lang::syntax::types::Ty::I64`].
#[proc_macro]
...
/// Create a [`core_lang::syntax::terms::mu::FsMu`] with chirality [`core_lang::syntax::Prd`] i.e.,
/// a focused mu binding with given variable name, bound statement, and type.
...
/// Create a [`core_lang::syntax::terms::mu::FsMu`] with chirality [`core_lang::syntax::Cns`] i.e.,
/// a focused mu-tilde binding with given variable, bound statement, and type.
/// If no type is provided, it defaults to [`core_lang::syntax::types::Ty::I64`].
#[proc_macro]
...
/// Create a [`core_lang::syntax::statements::Cut`] with given producer, consumer, and type.
/// If no type is provided, it will default to [`core_lang::syntax::types::Ty::I64`].
#[proc_macro]
...
/// Create a [`core_lang::syntax::statements::cut::FsCut`] with given producer, consumer, and tpye.
/// If no type is provided, it defaults to [`core_lang::syntax::types::Ty::I64`].
#[proc_macro]
...
/// [`core_lang::syntax::statements::ifc::IfSort::Equal`], given first and second arguments, then
...
/// Create a [`core_lang::syntax::statements::ifc::IfC`] with comparison
/// [`core_lang::syntax::statements::ifc::IfSort::NotEqual`], given first and second arguments, then
/// statement, and else statement.
/// If only one comparison argument is provided, default to using zero (i.e., `IfC.snd == None`).
#[proc_macro]
...
/// Create a [`core_lang::syntax::statements::ifc::IfC`] with comparison
/// [`core_lang::syntax::statements::ifc::IfSort::Less`], given first and second arguments, then
/// statement, and else statement.
/// If only one comparison argument is provided, default to using zero (i.e., `IfC.snd == None`).
#[proc_macro]
...
/// Create a [`core_lang::syntax::statements::ifc::IfC`] with comparison
/// [`core_lang::syntax::statements::ifc::IfSort::LessOrEqual`], given first and second arguments,
...
/// Create a [`core_lang::syntax::statements::ifc::IfC`] with comparison
/// [`core_lang::syntax::statements::ifc::IfSort::Greater`], given first and second arguments, then
/// statement, and else statement.
/// If only one comparison argument is provided, default to using zero (i.e., `IfC.snd == None`).
#[proc_macro]
...
/// Create a [`core_lang::syntax::statements::ifc::IfC`] with comparison
/// [`core_lang::syntax::statements::ifc::IfSort::GreaterOrEqual`], given first and second arguments,
/// then statement, and else statement.
/// If only one comparison argument is provided, default to using zero (i.e., `IfC.snd == None`).
#[proc_macro]
...
/// Create a [`core_lang::syntax::statements::Call`] with given label, arugments, and type.
...
/// Create a [`core_lang::syntax::statements::call::FsCall`] with given label and arguments.
#[proc_macro]
...
/// Create a [`core_lang::syntax::statements::FsExit`] with given variable.
#[proc_macro]
...
/// [`core_lang::syntax::terms::op::BinOp::Div`], i.e., a focused divistion term, and given first
/// and second operand variables.
#[proc_macro]
...
/// Create a [`core_lang::syntax::terms::op::FsOp`] with operation
/// [`core_lang::syntax::terms::op::BinOp::Prod`], i.e., a focused divistion term, and given first
/// and second operand variables.
#[proc_macro]
...
/// Create a [`core_lang::syntax::terms::op::FsOp`] with operation
/// [`core_lang::syntax::terms::op::BinOp::Rem`], i.e., a focused divistion term, and given first
/// and second operand variables.
#[proc_macro]
...
/// Create a [`core_lang::syntax::terms::op::FsOp`] with operation
/// [`core_lang::syntax::terms::op::BinOp::Sub`], i.e., a focused divistion term, and given first
/// and second operand variables.
#[proc_macro]
...
/// Create a [`core_lang::syntax::terms::op::FsOp`] with operation
/// [`core_lang::syntax::terms::op::BinOp::Sum`], i.e., a focused divistion term, and given first
/// and second operand variables.
#[proc_macro]
...
/// Create a [`core_lang::syntax::def::Def`] with given name, arguments, body, and used variables.
...
/// Create a [`core_lang::syntax::def::FsDef`] with given name, arguments, body, and used vars.
...
/// Create a [`core_lang::syntax::declaration::DataDeclaration`] with given name and list of
/// constructors.
#[proc_macro]
...
/// Create a [`core_lang::syntax::declaration::CodataDeclaration`] with given name and list of
/// destructors.
#[proc_macro]
...
/// Create a [`core_lang::syntax::declaration::CtorSig`] with given name and arguments.
#[proc_macro]
pub fn ctor_sig(input: TokenStream) -> TokenStream {
    declarations::ctor_sig(input)
}

/// Create a [`core_lang::syntax::declaration::DtorSig`] with given name and arguments.
#[proc_macro]
