...
///with given list of rearranges and next statement.
///rearrange expects a list of tuples `(ContextBinding, &str)`
#[proc_macro]
pub fn substitute(input: TokenStream) -> TokenStream {
    statements::substitute(input)
}

///Create a [`axcut::syntax::statements::let::Let`]
/// with given bound variable, type, tag, arguments, next statement and free variables next.
/// If no type is provided, it defaults to [`axcut::syntax::types::Ty::I64`].
...
///Create a [`axcut::syntax::statements::Switch`]
///with given switch variable, type, clauses and free variables clauses.
///If no type is provided, it defaults to [`axcut::syntax::types::Ty::I64`].
///If no `free_vars_next` are provided, it defaults to `None`
...
///Create a [`axcut::syntax::statements::invoke::Invoke`].
///with given variable, tag, type and arguments.
///If no type is provided, it defaults to [`axcut::syntax::types::Ty::I64`]
#[proc_macro]
...
///with given variable, type, context, clauses, free variables clauses, next statement and free
///variables next.
/// `type`, `context`, `free_vars_clauses` and `free_vars_next` are optional
/// and default to [`axcut::syntax::types::Ty::I64`] (for the type) and `None`.
...
///Create a [`axcut::syntax::statements::Literal`]
///with given literal, variable, next statement and free variables next
...
///with given variable, next statement and free variables next
///If `free_vars_next` are not provided, it defaults to `None`
#[proc_macro]
...
///and given variable, next statement and free variables next.
...
///with given xtor name, context and body
#[proc_macro]
...
///[`axcut::syntax::statements::op::BinOp::Div`]
///and given first operand, second operand, variable, next statement and free variables next.
///If `free_vars_next` is not provided, it defaults to `None`
#[proc_macro]
...
///Create a [`axcut::syntax::statements::op::Op`] with
///[`axcut::syntax::statements::op::BinOp::Prod`].
///and given first operand, second operand, variable, next statement and free variables next.
/// If `free_vars_next` is not provided, it defaults to `None`
#[proc_macro]
...
///Create a [`axcut::syntax::statements::op::Op`] with
///[`axcut::syntax::statements::op::BinOp::Rem`].
///and given first operand, second operand, variable, next statement and free variables next.
///If `free_vars_next` is not provided, it defaults to `None`
#[proc_macro]
...
///Create a [`axcut::syntax::statements::op::Op`] with
///[`axcut::syntax::statements::op::BinOp::Sum`]
///and given first operand, second operand, variable, next statement and free variables next.
///If `free_vars_next` is not provided, it defaults to `None`
#[proc_macro]
...
///Create a [`axcut::syntax::statements::op::Op`] with
///[`axcut::syntax::statements::op::BinOp::Sub`]
///and given first operand, second operand, variable, next statment and free variables next.
///If `free_vars_next` is not provided, it defaults to `None`
#[proc_macro]
...
///[`axcut::syntax::statements::ifc::IfSort::Equal`] and
///given first variable, second variable, then statement and else statement.
...
///Create a [`axcut::syntax::statements::ifc::IfC`] with comparison
///[`axcut::syntax::statements::ifc::IfSort::NotEqual`] and
///given first variable, second variable, then statement and else statement.
///If `snd` is not provided it defaults to `None` (i.e. compares to `0`)
#[proc_macro]
...
///Create a [`axcut::syntax::statements::ifc::IfC`] with comparison
///[`axcut::syntax::statements::ifc::IfSort::Less`] and
///given first variable, second variable, then statement and else statement.
///If `snd` is not provided, it defaults to `None` (i.e. compares to `0`)
#[proc_macro]
...
///Create a [`axcut::syntax::statements::ifc::IfC`] with comparison
///[`axcut::syntax::statements::ifc::IfSort::LessOrEqual`] and
///given first variable, second variable, then statement and else statement.
///If `snd` is not provided, it defaults to `None` (i.e. compares to `0`)
#[proc_macro]
...
///Create a [`axcut::syntax::statements::ifc::IfC`] with comparison
///[`axcut::syntax::statements::ifc::IfSort::Greater`] and
///given first variable, second variable, then statement and else statement.
///If `snd` is not provided, it defaults to `None` (i.e. compares to `0`)
#[proc_macro]
...
///Create a [`axcut::syntax::statements::ifc::IfC`] with comparison
///[`axcut::syntax::statements::ifc::IfSort::GreaterOrEqual`] and
///given first variable, second variable, then statement and else statement.
///If `snd` is not provided, it defaults to `None` (i.e. compares to `0`)
#[proc_macro]
...
///Create a [`axcut::syntax::def::Def`]
///with given name, context, body and used variables.
...
///with given name and list of xtors.
#[proc_macro]
...
///with given list of definitions and type declarations
#[proc_macro]
