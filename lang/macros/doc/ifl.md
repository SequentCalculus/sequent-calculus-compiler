...
let if1 = ifl!(Literal::new(1),Literal::new(1),Exit::exit(Literal::new(1),Ty::I64),Exit::exit(Literal::new(2),Ty::I64));
let if2 = IfC{
    sort: IfSort::Less,
...
let if1 = ifl!(Literal::new(1),Exit::exit(Literal::new(1),Ty::I64),Exit::exit(Literal::new(2),Ty::I64));
let if2 = IfC{
    sort:IfSort::Less,
    fst: Rc::new(Term::from(Literal::new(1))),
    snd: None,
