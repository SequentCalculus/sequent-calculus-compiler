...
impl From<Create1> for Statement {
    fn from(value: Create1) -> Self {
        Statement::Create1(value)
    }
}

impl FreeVars for Create1 {
...
impl TypedFreeVars for Create1 {
...
impl Subst for Create1 {
    fn subst_sim(mut self, subst: &[(ID, Identifier)]) -> Create1 {
