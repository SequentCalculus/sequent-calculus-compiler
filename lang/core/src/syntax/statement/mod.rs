...
impl Typed for Statement {
    fn get_type(&self) -> Ty {
        match self {
            ...
            Statement::IfC(ife) => ife.get_type(),
...
impl Print for Statement {
    fn print<'a>(
        ...
        match self {
            ...
            Statement::IfC(ife) => ife.print(cfg, alloc),
...
impl FreeV for Statement {
    fn free_vars(self: &Statement) -> HashSet<Var> {
        match self {
            ...
            Statement::IfC(ife) => ife.free_vars(),
    ...
    fn free_covars(self: &Statement) -> HashSet<Covar> {
        match self {
            ...
            Statement::IfC(ife) => ife.free_covars(),
...
impl UsedBinders for Statement {
    fn used_binders(&self, used: &mut HashSet<Var>) {
        match self {
            ...
            Statement::IfC(ife) => ife.used_binders(used),
...
impl Subst for Statement {
    ...
    fn subst_sim(
        ...
        match self {
            ...
            Statement::IfC(ife) => ife.subst_sim(prod_subst, cons_subst).into(),
...
impl Print for FsStatement {
    fn print<'a>(
        ...
        match self {
            ...
            FsStatement::IfC(ife) => ife.print(cfg, alloc),
...
impl SubstVar for FsStatement {
    ...
    fn subst_sim(self, subst: &[(Var, Var)]) -> FsStatement {
        match self {
            ...
            FsStatement::IfC(ife) => ife.subst_sim(subst).into(),
...
impl Uniquify for Statement {
    fn uniquify(self, seen_vars: &mut HashSet<Var>, used_vars: &mut HashSet<Var>) -> Statement {
        match self {
            ...
            Statement::IfC(ife) => ife.uniquify(seen_vars, used_vars).into(),
...
impl Focusing for Statement {
    ...
    fn focus(self: Statement, state: &mut FocusingState) -> crate::syntax::statement::FsStatement {
        match self {
            ...
            Statement::IfC(ife) => ife.focus(state),
