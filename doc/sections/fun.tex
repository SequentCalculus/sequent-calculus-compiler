In this section we are going to introduce the language \surfacelang\ that we want to compile to machine code.
...
% Variables and Let
Terms $t$ contain variables $x$ and non-recursive let-expressions $\letin{x}{t_1}{t_2}$, both of which are completely standard.
...
\begin{figure}[hbtp]
  ...
  \begin{minipage}{0.4\textwidth}
    \begin{prooftree}
      ...
      \BinaryInfC{$\Theta\mid\Gamma \vdash \lab{\alpha}{t} : \tau$}
    \end{prooftree}
  \end{minipage}
  \hfill
  ...
  \begin{minipage}{0.45\textwidth}
    \begin{prooftree}
      \AxiomC{$\data{T}{K\ \Gamma^{\prime}, \dots} \in \Theta$}
  ...
  \begin{minipage}{0.45\textwidth}
    \begin{prooftree}
      ...
      \BinaryInfC{$\Theta\mid\Gamma\vdash \caseof{t}{\overline{K_i\ \Gamma_i\Rightarrow t_i}} : \tau$}
    \end{prooftree}
  \end{minipage}
  \hfill
  \vspace{1em}
  ...
  \begin{minipage}{\textwidth}
    \begin{prooftree}
      \AxiomC{$\codata{T}{D\ \Gamma^{\prime}:\tau, \dots} \in \Theta$}
      \AxiomC{$\Theta\mid\Gamma\vdash \sigma:\Gamma^{\prime}$}
  ...
  \begin{minipage}{0.45\textwidth}
    \begin{prooftree}
      \AxiomC{$\codata{T}{\overline{D_i\ \Gamma_i:\tau_i}}\in \Theta$}
      \AxiomC{$\Theta\mid\Gamma,\Gamma_i \vdash t_i:\tau_i$}
      \RightLabel{\textsc{Cocase}}
      \BinaryInfC{$\Theta\mid\Gamma \vdash \cocase{\overline{D_i\ \Gamma_i} \Rightarrow t_i} : T$}
    \end{prooftree}
  \end{minipage}
  \hfill
  \begin{minipage}{0.45\textwidth}
...
\begin{minipage}{\textwidth}
  ...
  \begin{minipage}{0.35\textwidth}
    \begin{prooftree}
      \AxiomC{$\codata{T}{\ldots} \in \Theta$}
...
\begin{minipage}{\textwidth}
  ...
  \begin{minipage}{0.75\textwidth}
    \begin{prooftree}
      ...
      \AxiomC{$\overline{\Theta,\codata{T}{\dots}\vdash\goodctx{\Gamma_i}}$}
      \AxiomC{$\overline{ \Gamma_i \vdash \tau_i:\kappa}$}
      \RightLabel{\textsc{Wf-Codata}}
      \TrinaryInfC{$\vdash \wellformed{\Theta,\codata{T}{\overline{D_i\ \Gamma_i : \tau_i}}}$}
    \end{prooftree}
  \end{minipage}
  \hfill
  \vspace{1em}
  ...
  \begin{minipage}{0.45\textwidth}
    \begin{prooftree}
      \AxiomC{$\vdash \wellformed{\Theta}$}
      \AxiomC{$\Theta, \defi{f\ \Gamma : \tau}{t} \mid\Gamma \vdash t:\tau$}
      \RightLabel{\textsc{Wf-Def}}
      \BinaryInfC{$\vdash \wellformed{\Theta,\defi{f\ \Gamma : \tau}{t}}$}
    \end{prooftree}
  \end{minipage}
  \hfill
  \begin{minipage}{0.45\textwidth}
    \begin{prooftree}
      \AxiomC{$\vdash \wellformed{\Theta}$}
      \AxiomC{$\overline{\Theta,\data{T}{\dots}\vdash\goodctx{\Gamma_i}}$}
      \RightLabel{\textsc{Wf-Data}}
      \BinaryInfC{$\vdash \wellformed{\Theta,\data{T}{\overline{K_i\ \Gamma_i}}}$}
    \end{prooftree}
  \end{minipage}
  \hfill
  \vspace{1em}
