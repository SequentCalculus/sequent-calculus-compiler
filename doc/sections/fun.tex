...
\begin{minipage}{\textwidth}
  \begin{prooftree}
    ...
    \BinaryInfC{$\Theta\mid\Gamma\vdash \mathbf{case}\ t\ \mathbf{of}\ \{\overline{K_i\ \Gamma_i^{\prime}\Rightarrow t_i}\} : \tau$}
  \end{prooftree}
\end{minipage}
\hfill
\vspace{1em}
...
\begin{minipage}{\textwidth}
  \begin{prooftree}
    ...
    \BinaryInfC{$\Theta\mid\Gamma \vdash \mathbf{cocase} \{ \overline{D_i\ \Gamma_i^{\prime}} \Rightarrow t_i \} : T$}
  \end{prooftree}
\end{minipage}
...
\hfill
  ...
  \begin{minipage}{0.7\textwidth}
    \begin{prooftree}
      ...
      \AxiomC{$\Theta, \mathbf{def}\ \text{f}\ \Gamma\coloneq s \mid\Gamma \vdash s:\tau$}
