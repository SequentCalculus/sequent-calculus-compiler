...
\begin{definition}[Syntax of \surfacelang{}]
  ...
  \[
    \begin{array}{r c l l}
      ...
      \delta & \coloneqq & \data{T}{\overline{K\ \Gamma}}  \mid \codata{T}{\overline{D\ \Gamma : \tau}} \mid \defi{f\ \Gamma}{t} & \emph{Declarations}\\
...
\begin{minipage}{\textwidth}
  ...
  \begin{minipage}{0.45\textwidth}
    \begin{prooftree}
      \AxiomC{$\vdash \wellformed{\Theta}$}
      \AxiomC{$\Theta, \defi{f\ \Gamma}{t} \mid\Gamma \vdash t:\tau$}
      \RightLabel{\textsc{Wf-Def}}
      \BinaryInfC{$\vdash \wellformed{\Theta,\defi{f\ \Gamma}{t}}$}
    \end{prooftree}
  \end{minipage}
  \hfill
  \begin{minipage}{0.45\textwidth}
