...
There are $5$ different judgement forms to determine the well-typedness of expressions in Fun. These are the the following 
\begin{enumerate}
  \item Typing Terms: $\Theta\mid\Gamma \vdash t:\tau$ 
  \item Typing Subsitutions: $\Theta\mid\Gamma \vdash \sigma:\Gamma^{\prime}$
...
\begin{minipage}{\textwidth}
  ...
  \begin{minipage}{0.45\textwidth}
    \begin{prooftree}
      \AxiomC{$\Theta\mid\Gamma\vdash\sigma:\Gamma^{\prime}$}
      \AxiomC{$\Theta\mid\Gamma\vdash t:\tau$}
      \RightLabel{\textsc{Subst-Var}}
      \BinaryInfC{$\Theta\mid\Gamma \vdash \sigma,t : \Gamma^{\prime},x:\tau$}
    \end{prooftree}
  \end{minipage}
  \hfill
  \begin{minipage}{0.45\textwidth}
...
\begin{minipage}{\textwidth}
  ...
  \begin{minipage}{0.45\textwidth}
    \begin{prooftree}
      ...
      \TrinaryInfC{$\Theta\vdash\goodctx{\Gamma,x:\tau}$}
    \end{prooftree}
  \end{minipage}
  \hfill
  \vspace{1em}
