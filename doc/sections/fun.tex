...
\begin{minipage}{\textwidth}
  \begin{prooftree}
    ...
    \AxiomC{$\Theta\mid\Gamma,\overline{y_{i,j}\prd\tau_{i,j}} \vdash t_i:\tau$}
    \RightLabel{\textsc{Cocase}}
    \BinaryInfC{$\Theta\mid\Gamma \vdash \mathbf{cocase} \{ \overline{D_i(\overline{y_{i,j}};\overline{\beta_{i,k}})} \Rightarrow t_i \} : T$}
  \end{prooftree}
\end{minipage}
\end{minipage}
