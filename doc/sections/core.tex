...
As before, we also have judgements $\Theta\mid\Gamma\vdash\sigma:\Gamma^{\prime}$, $\wellformed{\Theta}$ and $\goodctx{\Gamma}$, but since these are identical to the ones in \surfacelang{}, they are omitted here.
  ...
  \begin{minipage}{\textwidth}
    ...
    \begin{minipage}{0.7\textwidth}
      \begin{prooftree}
        ...
        \AxiomC{$\overline{K_i},T$ do not occur in $\Theta$}
