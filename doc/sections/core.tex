The language \targetlang, introduced in this section, is the first of the languages which is directly influenced by the sequent calculus.
The skeleton of \targetlang\ is formed by the \lambdamumu-calculus of \citet{Curien2000duality}.
They, however, did not yet consider arbitrary data and codata types in their system, which were formalized by TODO.
The syntax of \targetlang\ is given in \cref{def:core:syntax}.
...
\begin{figure}
  \begin{minipage}{\textwidth}
    ...
    \begin{minipage}{0.45\textwidth}
      \begin{prooftree}
        \AxiomC{$\codata{T}{\overline{D_i\ \Gamma_i}}\in\Gamma$}
        \AxiomC{$\overline{\Theta\mid\Gamma,\Gamma_i \vdash s_i}$}
        \RightLabel{\textsc{Cocase}}
        \BinaryInfC{$\Theta\mid\Gamma \vdash \cocase{\overline{D_i\ \Gamma_i\Rightarrow s_i}} : T $}
      \end{prooftree}
    \end{minipage}
    \hfill
    \vspace{1em}
  ...
  \begin{minipage}{\textwidth}
    ...
    \begin{minipage}{0.45\textwidth}
      \begin{prooftree}
        \AxiomC{$\codata{T}{D\ \Gamma^{\prime}, \dots} \in \Gamma$}
    ...
    \begin{minipage}{0.45\textwidth}
      \begin{prooftree}
        \AxiomC{$\data{T}{\overline{K_i\ \Gamma_i}} \in \Gamma$}
        \AxiomC{$\overline{\Theta\mid\Gamma,\Gamma_i\vdash s_i}$}
        \RightLabel{\textsc{Case}}
        \BinaryInfC{$\Theta\mid\Gamma \vdash \case{\overline{K_i\ \Gamma_i\Rightarrow s_i}}  \cnt T$}
      \end{prooftree}
    \end{minipage}
    \hfill
    \vspace{1em}
  ...
  \begin{minipage}{\textwidth}
    ...
    \begin{minipage}{0.55\textwidth}
      \begin{prooftree}
        ...
        \BinaryInfC{$\vdash \wellformed{\Theta,\codata{T}{ \overline{D_i\ \Gamma_i}}}$}
      \end{prooftree}
    \end{minipage}
    \hfill
    \begin{minipage}{0.4\textwidth}
