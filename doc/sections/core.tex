...
The following are all judgements for Core:
\begin{itemize}
  \item Typing Producers: $\Theta\mid\Gamma\vdash p\prd\tau$\\
  \item Typing Consumers: $\Theta\mid\Gamma\vdash c\cnt\tau$\\
  \item Well-typedness of Statements: $\Theta\mid\Gamma \vdash s$\\
  \item Typing Substitutions: $\Theta\mid\Gamma\vdash \sigma:\Gamma^{\prime}$\\
  \item Well-formed Programs: $\vdash \wellformed{\Theta}$\\
  \item Kinding Types: $\Theta\vdash \tau:\kappa$\\
  \item Well-formed contexts: $\Theta\vdash\goodctx{\Gamma}$
\end{itemize}

\begin{minipage}{\textwidth}
  \vspace{1em}
  \judgementbox{Typing Producers}{$\Theta\mid\Gamma\vdash p\prd\tau$}
  \vspace{1em}
...
The remaining judgements are analogous to those of Fun.\\
\begin{minipage}{\textwidth}
  \vspace{1em}
  \judgementbox{Typing Substutitions}{$\Theta\mid\Gamma\vdash\sigma:\Gamma^{\prime}$}
...
\begin{minipage}{\textwidth}
  ...
  \begin{minipage}{0.3\textwidth}
    \begin{prooftree}
      \AxiomC{$\mathbf{data}\ T \{ \dots \} \in \Theta$}
  ...
  \begin{minipage}{0.3\textwidth}
    \begin{prooftree}
      \AxiomC{$\mathbf{codata}\ T \{\dots\} \in\Theta$}
...
\begin{minipage}{\textwidth}
  ...
  \begin{minipage}{0.45\textwidth}
    \begin{prooftree}
      ...
      \RightLabel{\textsc{ctx-var}}
      \TrinaryInfC{$\Theta\vdash \goodctx{\Gamma,x\prd\tau}$}
    \end{prooftree}
  \end{minipage}
  \hfill
  \begin{minipage}{0.45\textwidth}
