...
\[
  \begin{array}{rcll}
    \multicolumn{4}{c}{\translatestar{\cdot{}}{} : \emph{Definition}_{Fun} \rightarrow \emph{Definition}_{Core}}\\
    \translatestar{\defi{f(\overline{x}; \overline{\alpha})}{t}}{} & \coloneq & \defi{f(\overline{x}; \overline{\alpha}, \alpha)}{\cut{\translate{t}}{\alpha}} & \fresh{\alpha}\\
    \\
    \multicolumn{4}{c}{\translatestar{\cdot{}}{} : \emph{Declaration}_{Fun} \rightarrow \emph{Declaration}_{Core}}\\
    \translatestar{\mathbf{data}\ T \{ \overline{K_i\ \Gamma_i} \}}{} & \coloneq & \mathbf{data} \{ \overline{K_i\ \translate{\Gamma_i}}\}\\
    \translatestar{\mathbf{codata}\ T \{ \overline{D_i\ \Gamma_i : \tau} \}}{} & \coloneq & \mathbf{codata} \{ \overline{D_i\ \translate{\Gamma_i},\alpha\cnt\tau}\} & \fresh{\alpha}\\
    \multicolumn{4}{c}{\translatestar{\cdot{}}{} : \emph{Typing Context}_{Fun} \rightarrow \emph{Typing Context}_{Core}}\\
    \translatestar{\nil}{} & \coloneq & \nil \\
    \translatestar{\Gamma,x:\tau}{} & \coloneq & \translate{\Gamma}, x\prd\tau\\
    \translatestar{\Gamma,\alpha\cnt\tau}{} & \coloneq & \translate{\Gamma}, \alpha\cnt\tau\\
    \\
