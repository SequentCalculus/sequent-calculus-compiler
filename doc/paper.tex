...
\input{sections/redundancy.tex}

%%
%% Section: Substructurality Transformation
%%
\section{Substructurality Anaysis}
\label{sec:substructurality-analysis}
\input{sections/substructurality.tex}
