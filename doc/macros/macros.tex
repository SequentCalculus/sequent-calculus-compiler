...
\newcommand{\grey}[1]{\textcolor{textgray}{#1}}
...
\newcommand{\substitute}[2]{\ensuremath{[#1]; #2}}
\newcommand{\substituteac}[2]{\ensuremath{\mathbf{substitute}[#1]; #2}}
\newcommand{\letac}[3]{\ensuremath{\mathbf{let}\, #1 = #2; #3}}
\newcommand{\new}[3]{\ensuremath{\mathbf{new}\, #1 = #2; #3}}
\newcommand{\bra}[1]{\ensuremath{\{ #1 \}}}
\newcommand{\ifzac}[3]{\ensuremath{\mathbf{ifz}(#1)\bra{() \Rightarrow #2, () \Rightarrow #3}}}
\newcommand{\litac}[3]{\ensuremath{\mathbf{lit}[\lit{#1}]\bra{#2 \Rightarrow #3}}}
\newcommand{\opac}[3]{\ensuremath{\odot(#1)\bra{#2 \Rightarrow #3}}}
\newcommand{\extern}[2]{\ensuremath{\mathbf{extern}\, #1\bra{#2}}}
...
\newcommand{\targetvar}{\textbf{CoreV}}
\newcommand{\targetred}{\textbf{CoreR}}
\newcommand{\targetsub}{\textbf{CoreS}}
...
\newcommand{\data}[2]{\mathbf{data}\, #1\, \{ #2 \}}
\newcommand{\codata}[2]{\mathbf{codata}\, #1\, \{ #2 \}}
\newcommand{\sig}[2]{\mathbf{signature}\, #1\, \{ #2 \}}
...
\newcommand{\bind}[2]{\ensuremath{\mathcal{B}(#1)[#2]}}
\newcommand{\binds}[2]{\ensuremath{\mathcal{M}(#1)[#2]}}
\newcommand{\redundancy}[1]{\ensuremath{\mathcal{R}(#1)}}
\newcommand{\substruct}[2]{\ensuremath{\mathcal{S}(#1)_{#2}}}
\newcommand{\collapse}[1]{\ensuremath{\mathcal{C}(#1)}}
