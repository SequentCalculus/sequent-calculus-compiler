...
int asm_main(void *heap, int64_t input1, int64_t input2, int64_t input3, int64_t input4) asm("asm_main");
...
int main(int argc, char *argv[]) {
  ...
  val = asm_main(heap, atoi(argv[1]), atoi(argv[2]), atoi(argv[3]), atoi(argv[4]));
