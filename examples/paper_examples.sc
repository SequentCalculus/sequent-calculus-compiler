...
def mult2(l:ListI64,a:cns i64) : i64 { l.case { Nil => 1,
                                                Cons(x:i64, xs:ListI64) => ifz(x) {goto(0; a)} else {x * mult2(xs, a)}}}
...
def criticalEta1(b:cns FunI64I64) : FunI64I64 { let x : FunI64I64 = cocase { Ap(y:i64) => goto(cocase { Ap(z:i64) => 1 }; b).Ap(y) }; cocase { Ap(z:i64) => 3 }}
def criticalEta2(b:cns FunI64I64) : FunI64I64 { let x : FunI64I64 = goto(cocase { Ap(z:i64) => 1 }; b); cocase { Ap(z:i64) => 3 }}
