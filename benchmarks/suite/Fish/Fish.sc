...
def vec_add(v1: Vec, v2: Vec): Vec {
    v1.case { Vec(x1, y1) => v2.case { Vec(x2, y2) => Vec(x1 + x2, y1 + y2) } }
}
...
def scale_vec2(v: Vec, a: i64, b: i64): Vec {
    v.case { Vec(x, y) => Vec((x * a) / b, (y * a) / b) }
}

def p_tile(): List[Vec4] {
    let p5: List[Vec4] = Cons(
        Vec4(10, 4, 13, 5),
        Cons(Vec4(13, 5, 16, 4), Cons(Vec4(11, 0, 14, 2), Cons(Vec4(14, 2, 16, 2), Nil)))
    );
    let p4: List[Vec4] = Cons(
        Vec4(8, 12, 16, 10),
        Cons(
            Vec4(8, 8, 12, 9),
            Cons(Vec4(12, 9, 16, 8), Cons(Vec4(9, 6, 12, 7), Cons(Vec4(12, 7, 16, 6), p5)))
        )
    );
    let p3: List[Vec4] = Cons(
        Vec4(10, 16, 12, 14),
        Cons(
            Vec4(12, 14, 16, 13),
            Cons(Vec4(12, 16, 13, 15), Cons(Vec4(13, 15, 16, 14), Cons(Vec4(14, 16, 16, 15), p4)))
        )
    );
    let p2: List[Vec4] = Cons(
        Vec4(4, 13, 0, 16),
        Cons(
            Vec4(0, 16, 6, 15),
            Cons(Vec4(6, 15, 8, 16), Cons(Vec4(8, 16, 12, 12), Cons(Vec4(12, 12, 16, 12), p3)))
        )
    );
    let p1: List[Vec4] = Cons(
        Vec4(4, 10, 7, 6),
        Cons(
            Vec4(7, 6, 4, 5),
            Cons(
                Vec4(11, 0, 10, 4),
                Cons(Vec4(10, 4, 9, 6), Cons(Vec4(9, 6, 8, 8), Cons(Vec4(8, 8, 4, 13), p2)))
            )
        )
    );
    let p: List[Vec4] = Cons(
        Vec4(0, 3, 3, 4),
        Cons(
            Vec4(3, 4, 0, 8),
            Cons(Vec4(0, 8, 0, 3), Cons(Vec4(6, 0, 4, 4), Cons(Vec4(4, 5, 4, 10), p1)))
        )
    );
    p
}
...
def q_tile(): List[Vec4] {
    ...
    let q6: List[Vec4] = Cons(
        Vec4(13, 0, 16, 6),
        Cons(
            Vec4(14, 0, 16, 4),
            Cons(Vec4(15, 0, 16, 2), Cons(Vec4(0, 0, 8, 0), Cons(Vec4(12, 0, 16, 0), q7)))
        )
    );
    let q5: List[Vec4] = Cons(
        Vec4(10, 0, 14, 11),
        Cons(
            Vec4(12, 0, 13, 4),
            Cons(Vec4(13, 4, 16, 8), Cons(Vec4(16, 8, 15, 10), Cons(Vec4(15, 10, 16, 16), q6)))
        )
    );
    let q4: List[Vec4] = Cons(
        Vec4(4, 5, 4, 7),
        Cons(
            Vec4(4, 0, 6, 5),
            Cons(Vec4(6, 5, 6, 7), Cons(Vec4(6, 0, 8, 5), Cons(Vec4(8, 5, 8, 8), q5)))
        )
    );
    let q3: List[Vec4] = Cons(
        Vec4(11, 15, 9, 13),
        Cons(
            Vec4(10, 10, 8, 12),
            Cons(Vec4(8, 12, 12, 12), Cons(Vec4(12, 12, 10, 10), Cons(Vec4(2, 0, 4, 5), q4)))
        )
    );
    let q2: List[Vec4] = Cons(
        Vec4(4, 16, 5, 14),
        Cons(
            Vec4(6, 16, 7, 15),
            Cons(Vec4(0, 10, 7, 11), Cons(Vec4(9, 13, 8, 15), Cons(Vec4(8, 15, 11, 15), q3)))
        )
    );
    let q1: List[Vec4] = Cons(
        Vec4(0, 12, 3, 13),
        Cons(
            Vec4(3, 13, 5, 14),
            Cons(Vec4(5, 14, 7, 15), Cons(Vec4(7, 15, 8, 16), Cons(Vec4(2, 16, 3, 13), q2)))
        )
    );
    let q: List[Vec4] = Cons(
        Vec4(0, 8, 4, 7),
        Cons(
            Vec4(4, 7, 6, 7),
            Cons(Vec4(6, 7, 8, 8), Cons(Vec4(8, 8, 12, 10), Cons(Vec4(12, 10, 16, 16), q1)))
        )
    );
    q
}
...
def r_tile(): List[Vec4] {
    let r4: List[Vec4] = Cons(
        Vec4(11, 16, 12, 12),
        Cons(
            Vec4(12, 12, 16, 8),
            Cons(Vec4(13, 13, 16, 10), Cons(Vec4(14, 14, 16, 12), Cons(Vec4(15, 15, 16, 14), Nil)))
        )
    );
    let r3: List[Vec4] = Cons(
        Vec4(2, 2, 8, 0),
        Cons(
            Vec4(3, 3, 8, 2),
            Cons(Vec4(8, 2, 12, 0), Cons(Vec4(5, 5, 12, 3), Cons(Vec4(12, 3, 16, 0), r4)))
        )
    );
    let r2: List[Vec4] = Cons(
        Vec4(5, 10, 2, 12),
        Cons(
            Vec4(2, 12, 0, 16),
            Cons(Vec4(16, 8, 12, 12), Cons(Vec4(12, 12, 11, 16), Cons(Vec4(1, 1, 4, 0), r3)))
        )
    );
    let r1: List[Vec4] = Cons(
        Vec4(16, 6, 11, 10),
        Cons(
            Vec4(11, 10, 6, 16),
            Cons(Vec4(16, 4, 14, 6), Cons(Vec4(14, 6, 8, 8), Cons(Vec4(8, 8, 5, 10), r2)))
        )
    );
    let r: List[Vec4] = Cons(
        Vec4(0, 0, 8, 8),
        Cons(
            Vec4(12, 12, 16, 16),
            Cons(Vec4(0, 4, 5, 10), Cons(Vec4(0, 8, 2, 12), Cons(Vec4(0, 12, 1, 14), r1)))
        )
    );
    r
}
...
def s_tile(): List[Vec4] {
    let s5: List[Vec4] = Cons(
        Vec4(15, 5, 13, 7),
        Cons(Vec4(13, 7, 15, 8), Cons(Vec4(15, 8, 15, 5), Nil))
    );
    let s4: List[Vec4] = Cons(
        Vec4(15, 9, 16, 8),
        Cons(
            Vec4(10, 16, 11, 10),
            Cons(Vec4(12, 4, 10, 6), Cons(Vec4(10, 6, 12, 7), Cons(Vec4(12, 7, 12, 4), s5)))
        )
    );
    let s3: List[Vec4] = Cons(
        Vec4(7, 8, 7, 13),
        Cons(
            Vec4(7, 13, 8, 16),
            Cons(Vec4(12, 16, 13, 13), Cons(Vec4(13, 13, 14, 11), Cons(Vec4(14, 11, 15, 9), s4)))
        )
    );
    let s2: List[Vec4] = Cons(
        Vec4(14, 11, 16, 12),
        Cons(
            Vec4(15, 9, 16, 10),
            Cons(Vec4(16, 0, 10, 4), Cons(Vec4(10, 4, 8, 6), Cons(Vec4(8, 6, 7, 8), s3)))
        )
    );
    let s1: List[Vec4] = Cons(
        Vec4(0, 8, 8, 6),
        Cons(
            Vec4(0, 10, 7, 8),
            Cons(Vec4(0, 12, 7, 10), Cons(Vec4(0, 14, 7, 13), Cons(Vec4(13, 13, 16, 14), s2)))
        )
    );
    let s: List[Vec4] = Cons(
        Vec4(0, 0, 4, 2),
        Cons(
            Vec4(4, 2, 8, 2),
            Cons(Vec4(8, 2, 16, 0), Cons(Vec4(0, 4, 2, 1), Cons(Vec4(0, 6, 7, 4), s1)))
        )
    );
    s
}

def nil(a: Vec, b: Vec, c: Vec): List[Vec4] {
    Nil
}

def tup2(a_b: Vec, c_d: Vec): Vec4 {
    a_b.case { Vec(a, b) => c_d.case { Vec(c, d) => Vec4(a, b, c, d) } }
}
...
def beside(
    m: i64,
    n: i64,
    p: Fun3[Vec, Vec, Vec, List[Vec4]],
    q: Fun3[Vec, Vec, Vec, List[Vec4]],
    a: Vec,
    b: Vec,
    c: Vec
): List[Vec4] {
    append(
        ...
        q.apply3[Vec, Vec, Vec, List[Vec4]](
            vec_add(a, scale_vec2(b, m, m + n)),
            scale_vec2(b, n, n + m),
            c
        )
    )
...
def above(
    ...
    append(
        p.apply3[Vec, Vec, Vec, List[Vec4]](
            vec_add(a, scale_vec2(c, n, m + n)),
            b,
            scale_vec2(c, m, n + m)
        ),
    ...
    quartet(
        ...
        new {
            apply3(a, b, c) =>
                rot(
                    new {
                        apply3(a, b, c) => rot(new { apply3(a, b, c) => rot(p1, a, b, c) }, a, b, c)
                    },
                    a,
                    b,
                    c
        ...
        new { apply3(a, b, c) => rot(new { apply3(a, b, c) => rot(p1, a, b, c) }, a, b, c) },
        arg,
        p3,
        p4
    )
...
def enum_from_to(from: i64, t: i64): List[i64] {
    if from <= t { Cons(from, enum_from_to(from + 1, t)) } else { Nil }
}
